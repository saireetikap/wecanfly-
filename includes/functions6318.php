...
function req_stock()
{
	$ins=executework("insert into approvestock_det(id,user_id,num_units,date,status) values('','".$_SESSION['sample_id']."','".$_POST['num_units']."','".date('Y-m-d H:i:s')."','1')");
	$ins_id=@mysql_insert_id($ins);
...
function rise_price()
{
	$ins=executework("insert into quote_price(id,stock_id,manf_id,price,date,status) values('','".$_POST['sub']."','".$_SESSION['sample_id']."','".$_POST['price']."','".date('Y-m-d H:i:s')."','1')");
	$ins_id=@mysql_insert_id();
	redirect("mdashboard.php?succ=1");
}
?>