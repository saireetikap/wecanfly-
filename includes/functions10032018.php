...
function reg_school_officials_new()
{
$ins=executework("insert into sample_reg(id,name,username,password,psw,city,district,type,type_name,reg_date,status,state) values('','".$_POST['name']."','".$_POST['uname']."','".$_POST['psw']."','".md5($_POST['psw'])."','".$_POST['city']."','".$_POST['dist']."','2','govt Officials','".date('Y-m-d H:i:s')."','0','".$_POST['state']."')");
$ins_id=@mysql_insert_id();
	//echo $ins_id;
		  ...
		  $lines[]=$col;
			if($col[0]!="")
			{
				...
				else
				{
					...
					{
					$sell=executework("select * from sample_govt_officials where id='".$_POST['school_name']."'");
					$row=@mysql_fetch_array($sell);
					$ins=executework("insert into sample_govt_officials(id,userdet_id,student_name,age,gender,school_name,city,district,state,address,aadhar) values('','".$ins_id."','".$col[0]."','".$col[1]."','".$col[2]."','".$row['school_name']."','".$col[4]."','".$col[5]."','".$col[6]."','".$col[7]."','".$col[8]."')");
					}
					else
					{
					$ins=executework("insert into sample_govt_officials(id,userdet_id,student_name,age,gender,school_name,city,district,state,address,aadhar) values('','".$ins_id."','".$col[0]."','".$col[1]."','".$col[2]."','".$col[3]."','".$col[4]."','".$col[5]."','".$col[6]."','".$col[7]."','".$col[8]."')");
