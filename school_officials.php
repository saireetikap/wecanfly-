...
{
reg_school_officials();
}
?>
<form id="form1" name="form1" method="post" action=""  enctype="multipart/form-data" onsubmit="return valid_reg();">
<h3 style="color:#950255; padding-left:170px; margin-top:35px">School Officials Registration</h3>
<br />
<div id="error_form1" style="color:#B70000;padding-left:150px;"></div>
  ...
  <?php } ?>
    ...
    <tr>
      <td>School Name:&nbsp;&nbsp;<strong>:</strong></td>
    </tr>
	<tr>
	...
	<tr>
	 ...
	 <tr>
      ...
      <td><input type="text" name="city" id="city" value="<?php echo $_POST['city']; ?>" /></td>
    </tr>
